...
@javax.annotation.Generated(
    ...
    comments = "Source: authzed/api/v1alpha1/schema.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class SchemaServiceGrpc {

  private SchemaServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "authzed.api.v1alpha1.SchemaService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest,
      com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> getReadSchemaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReadSchema",
      requestType = com.authzed.api.v1alpha1.Schema.ReadSchemaRequest.class,
      responseType = com.authzed.api.v1alpha1.Schema.ReadSchemaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest,
      com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> getReadSchemaMethod() {
    io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest, com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> getReadSchemaMethod;
      ...
      synchronized (SchemaServiceGrpc.class) {
        if ((getReadSchemaMethod = SchemaServiceGrpc.getReadSchemaMethod) == null) {
          SchemaServiceGrpc.getReadSchemaMethod = getReadSchemaMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1alpha1.Schema.ReadSchemaRequest, com.authzed.api.v1alpha1.Schema.ReadSchemaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReadSchema"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1alpha1.Schema.ReadSchemaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1alpha1.Schema.ReadSchemaResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest,
      com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> getWriteSchemaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WriteSchema",
      requestType = com.authzed.api.v1alpha1.Schema.WriteSchemaRequest.class,
      responseType = com.authzed.api.v1alpha1.Schema.WriteSchemaResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest,
      com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> getWriteSchemaMethod() {
    io.grpc.MethodDescriptor<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest, com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> getWriteSchemaMethod;
      ...
      synchronized (SchemaServiceGrpc.class) {
        if ((getWriteSchemaMethod = SchemaServiceGrpc.getWriteSchemaMethod) == null) {
          SchemaServiceGrpc.getWriteSchemaMethod = getWriteSchemaMethod =
              io.grpc.MethodDescriptor.<com.authzed.api.v1alpha1.Schema.WriteSchemaRequest, com.authzed.api.v1alpha1.Schema.WriteSchemaResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WriteSchema"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1alpha1.Schema.WriteSchemaRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.authzed.api.v1alpha1.Schema.WriteSchemaResponse.getDefaultInstance()))
  ...
  public static final class SchemaServiceBlockingStub
     ...
     * </pre>
     */
    public com.authzed.api.v1alpha1.Schema.ReadSchemaResponse readSchema(com.authzed.api.v1alpha1.Schema.ReadSchemaRequest request) {
     ...
     * </pre>
     */
    public com.authzed.api.v1alpha1.Schema.WriteSchemaResponse writeSchema(com.authzed.api.v1alpha1.Schema.WriteSchemaRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class SchemaServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.authzed.api.v1alpha1.Schema.ReadSchemaResponse> readSchema(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.authzed.api.v1alpha1.Schema.WriteSchemaResponse> writeSchema(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_READ_SCHEMA:
          serviceImpl.readSchema((com.authzed.api.v1alpha1.Schema.ReadSchemaRequest) request,
              (io.grpc.stub.StreamObserver<com.authzed.api.v1alpha1.Schema.ReadSchemaResponse>) responseObserver);
          break;
        case METHODID_WRITE_SCHEMA:
          serviceImpl.writeSchema((com.authzed.api.v1alpha1.Schema.WriteSchemaRequest) request,
              (io.grpc.stub.StreamObserver<com.authzed.api.v1alpha1.Schema.WriteSchemaResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.authzed.api.v1alpha1.Schema.ReadSchemaRequest,
              com.authzed.api.v1alpha1.Schema.ReadSchemaResponse>(
                service, METHODID_READ_SCHEMA)))
        .addMethod(
          getWriteSchemaMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.authzed.api.v1alpha1.Schema.WriteSchemaRequest,
              com.authzed.api.v1alpha1.Schema.WriteSchemaResponse>(
  ...
  private static abstract class SchemaServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.authzed.api.v1alpha1.Schema.getDescriptor();
    }
